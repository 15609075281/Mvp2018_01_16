...
import com.hc.mvp.Advertising.AdvertisingCampaignActivity;
import com.hc.mvp.R;
...
public class MainActivity extends BaseActivity {
    ...
    public void findview() {
        ...
        advertising = (LinearLayout) findViewById(R.id.advertising);
...
//        fragmentList.add(new MallFragment());
        ...
        advertising.setOnClickListener(listener);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.advertising:
                    ...
                    startActivity(new Intent(MainActivity.this, AdvertisingCampaignActivity.class));
